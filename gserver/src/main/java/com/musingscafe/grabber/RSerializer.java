...
public class RSerializer{
    ...
    private static byte[] convertToBytes(Serializable serializable, int serializationMode) {
    ...
    private static byte[] bytesWithPrefix(byte[] bytes, int serializationMode){
        byte[] prefixedBytes;
    ...
    private static byte[] addPrefix(byte[] bytes, byte prefix){
    ...
    private static byte[] removePrefix(byte[] bytes)
    {
    ...
    private static Object convertToObject(byte[] value) {
        if(value == null){
            return null;
        }
        byte[] bytes = value;
